...
//      @GetMapping("/client_registration")
        public String addClient(@ModelAttribute("clientForm") @Valid User userForm, @ModelAttribute("partnerForm") @Valid User partnerForm,BindingResult bindingResult, Model model) {
          boolean ch = true;
          if (bindingResult.hasErrors()) {
              return "index";
          }
